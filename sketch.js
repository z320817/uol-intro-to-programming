...
function preload() {
	...
	icons.visualisation.wave.on = loadImage('assets/images/visualisation/wavePattern/on.svg');
	icons.visualisation.wave.off = loadImage('assets/images/visualisation/wavePattern/off.svg');
